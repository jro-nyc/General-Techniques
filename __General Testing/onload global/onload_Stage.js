...
optGlobal.setTrials = function()
{
	...
	optGlobal.objTrials.home = [
		new optGlobal.classTrial("/trial/618/p/studentforwardcard.437/12/content.js", "stu_home", throt, "opStuThrottle", optimost.SLD(), 2592000),
		new optGlobal.classTrial("/trial/618/p/thankyoupreferred.93a/13/content.js", "typ_home", throt, "opTypThrottle", optimost.SLD(), 2592000)
	];
	
	optGlobal.objTrials.cards = [
		new optGlobal.classTrial("/trial/618/p/studentforwardcard.437/12/content.js", "stu_cards", throt, "opStuThrottle", optimost.SLD(), 2592000),
		new optGlobal.classTrial("/trial/618/p/thankyoupreferred.93a/13/content.js", "typ_cards", throt, "opTypThrottle", optimost.SLD(), 2592000)
	];
	
	optGlobal.objTrials.reward = [
		new optGlobal.classTrial("/trial/618/p/studentforwardcard.437/12/content.js", "stu_reward", throt, "opStuThrottle", optimost.SLD(), 2592000),
		new optGlobal.classTrial("/trial/618/p/thankyoupreferred.93a/13/content.js", "typ_reward", throt, "opTypThrottle", optimost.SLD(), 2592000)
	];
	
	optGlobal.objTrials.compare = [
		new optGlobal.classTrial("/trial/618/p/studentforwardcard.437/12/content.js", "stu_compare", throt, "opStuThrottle", optimost.SLD(), 2592000),
		new optGlobal.classTrial("/trial/618/p/thankyoupreferred.93a/13/content.js", "typ_compare", throt, "opTypThrottle", optimost.SLD(), 2592000)
	];
	...
	optGlobal.objTrials.students = new optGlobal.classTrial("/trial/618/p/studentforwardcard.437/12/content.js", "stu_students", throt, "opStuThrottle", optimost.SLD(), 2592000);	
	
	optGlobal.objTrials.cards_stu = new optGlobal.classTrial("/trial/618/p/studentforwardcard.437/12/content.js", "stu_cards", throt, "opStuThrottle", optimost.SLD(), 2592000);
	
	optGlobal.objTrials.cards_typ = new optGlobal.classTrial("/trial/618/p/thankyoupreferred.93a/13/content.js", "typ_cards", throt, "opTypThrottle", optimost.SLD(), 2592000);
	optGlobal.objTrials.details_typ = new optGlobal.classTrial("/trial/618/p/thankyoupreferred.93a/13/content.js", "typ_detail", throt, "opTypThrottle", optimost.SLD(), 2592000);
}
